...
$totalUnder = 0;
	...
	if($startDate != '' || $endDate != ''){
		...
		echo "<tr class='".$emp['department_id']."'><td>Checkin - Checkout</td>".$io."<td></td></tr>";
		echo "<tr class='".$emp['department_id']."'><td>Late in Minutes</td>".$late."<td>$totalLates</td></tr>";
		echo "<tr class='".$emp['department_id']."'><td>Undertime in Minutes</td>".$ut."<td>$totalUnder</td></tr>";
		$currD = null;
		$io = null;
		$late = null;
		$ut = null;
